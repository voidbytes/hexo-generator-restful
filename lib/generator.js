    ...
    var restful = cfg.hasOwnProperty('restful') ? cfg.restful :
        ...
        postMap = function (post) {
            return {
                ...
                excerpt: posts_props('excerpt', pages.excerpt ?minify(pages.excerpt): minify(page.content).substring(0, 50)),
        ...
        apiData = apiData.concat(posts.map(function (post) {
            ...
            return {
                ...
                data: JSON.stringify({
                    ...
                    path: path,
                    excerpt: pages.excerpt ?minify(pages.excerpt): minify(page.content).substring(0, 50) ,
